...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to create new loan for an Account inside EazyBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    @Operation(
            ...
            description = "REST API to fetch loan details based on a mobile number for an customer"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
